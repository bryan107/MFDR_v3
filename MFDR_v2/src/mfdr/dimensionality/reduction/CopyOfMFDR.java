...
//
//public class CopyOfMFDR extends DimensionalityReduction {
//	private static Log logger = LogFactory.getLog(CopyOfMFDR.class);
...
//	 * @param weight_freq
//	 */
//	public CopyOfMFDR(int NoC_t, int NoC_s) {
