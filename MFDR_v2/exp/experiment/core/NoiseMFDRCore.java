...
//					RepresentationErrorResult r_mfdr_n = runOptimalSolutionMFDR(tsset, new BAKMFDRParameterFacade(z,6.5,0.5), NoC ,true);
//					count ++;
//					System.out.println("PROGRESS:"+ (count*100 / 32 / filenamelist.size()) + "%");	
//					outputstring += "M," + r_mfdr_n.errMean()+",V," + r_mfdr_n.errVariance()+",T," + r_mfdr_n.timeMean()+",,";
//				}
//			
//				//------------------------- Output -------------------------
...
//				}
//				//  MFDR
//				RepresentationErrorResult r_mfdr = runMFDR1000(tsset, pairlist,	new BAKMFDRParameterFacade(3, 0.66, 6.5), NoC, false);
//				count++;
...
//				//  MFDR-N
//				for(double z = zstart ; z <= zend; z++){
//					RepresentationErrorResult r_mfdr_n = runMFDR1000(tsset,	pairlist, new BAKMFDRParameterFacade(z,6.5,0.65), NoC, true);
//					count++;
...
//			LinkedList<TimeSeries> tsset, BAKMFDRParameterFacade facade, int NoC,
//			boolean usenoise) {
...
//			int[][] pairlist, BAKMFDRParameterFacade facade, int NoC,
//			boolean use_noise) {
