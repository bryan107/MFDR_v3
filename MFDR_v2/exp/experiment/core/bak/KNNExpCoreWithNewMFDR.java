...
//				// Output
//				String outputstring = filenamelist.get(i) + ",[" + NoC + "],";
//				outputstring += "PLA,M," + r_pla.errMean() + ",V,"
//						+ r_pla.errVariance() + ",T," + r_pla.timeMean() + ",";
//				outputstring += "DFTWave,M," + r_dftwave.errMean() + ",V,"
//						+ r_dftwave.errVariance() + ",T," + r_dftwave.timeMean() + ",";
//				outputstring += "DFT,M," + r_dft.errMean() + ",V,"
//						+ r_dft.errVariance() + ",T," + r_dft.timeMean() + ",";
//				outputstring += "PAA,M," + r_paa.errMean() + ",V,"
//						+ r_paa.errVariance() + ",T," + r_paa.timeMean() + ",";
//				outputstring += "MFDR,M," + r_mfdr.errMean() + ",V,"
//						+ r_mfdr.errVariance() + ",T," + r_mfdr.timeMean() + ",";
//				outputstring += "MFDR-N,M," + r_mfdr_n.errMean() + ",V,"
//						+ r_mfdr_n.errVariance() + ",T," + r_mfdr_n.timeMean() + ",";
//				fagent.writeLineToFile(outputstring);
