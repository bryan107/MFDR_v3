...
//		BAKMFDRParameterFacade facade = new BAKMFDRParameterFacade(3,0.5,6.5);
//		double count = 0;
...
//			//  PLA
//			outputstring += "M," + r_pla.errMean()+",V," + r_pla.errVariance()+",T," + r_pla.timeMean()+",,";
//		    //  DFTWave
//			outputstring += "M," + r_dftwave.errMean()+",V," + r_dftwave.errVariance()+",T," + r_dftwave.timeMean()+",";
//		//  DFT
//			outputstring += "M," + r_dft.errMean()+",V," + r_dft.errVariance()+",T," + r_dft.timeMean()+",,";
//		//  PAA
//			outputstring += "M," + r_paa.errMean()+",V," + r_paa.errVariance()+",T," + r_paa.timeMean()+",,";
//		//  MFDR-wave
//			outputstring += "M," + 0+",V," + 0+",T," + 0+",";
//		//  MFDR-wave-N
//			outputstring += "M," + 0+",V," + 0+",T," + 0+",";
//		//  MFDR
//			outputstring += "M," + r_mfdr_t.errMean()+",V," + r_mfdr_t.errVariance()+",T," + r_mfdr_t.timeMean()+",,";
...
//			// Output
//			String outputstring = filenamelist.get(i) + ",[" + NoC+"],";
//			outputstring += "MFDR,M," + r_mfdr.errMean()+",V," + r_mfdr.errVariance()+",T," + r_mfdr.timeMean()+",";
//			fagent.writeLineToFile(outputstring);
//			System.out.println("PROGRESS: " + filenamelist.get(i) + "[" + NoC + "] Stored...");
//			}
//		}
...
//			// Output
//			String outputstring = filenamelist.get(i) + ",[" + NoC+"],";
//			outputstring += "PLA,M," + r_pla.errMean()+",V," + r_pla.errVariance()+",T," + r_pla.timeMean()+",";
////			outputstring += "DFTWave,M," + r_dftwave.mean()+",V," + r_dftwave.variance()+",T," + r_dftwave.time()+",";
//			outputstring += "DFT,M," + r_dft.errMean()+",V," + r_dft.errVariance()+",T," + r_dft.timeMean()+",";
//			outputstring += "PAA,M," + r_paa.errMean()+",V," + r_paa.errVariance()+",T," + r_paa.timeMean()+",";
...
//	}
//	
//	public RepresentationErrorResult runMFDR1000(LinkedList<TimeSeries> tsset, int[][] pairlist, BAKMFDRParameterFacade facade, int NoC, boolean use_noise){
