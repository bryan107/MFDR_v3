...
//			outputstring += "DFTWave,M," + r_dftwave.errMean()+",V," + r_dftwave.errVariance()+",T," + r_dftwave.timeMean()+",";
...
//			outputstring += "MFDR-T,M," + r_mfdr_t.errMean()+",V," + r_mfdr_t.errVariance()+",T," + r_mfdr_t.timeMean()+",";
