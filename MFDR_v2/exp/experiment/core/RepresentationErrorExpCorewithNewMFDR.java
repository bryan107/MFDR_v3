...
//			outputstring += "MFDR-N,M," + r_mfdr_n.errMean()+",V," + r_mfdr_n.errVariance()+",T," + r_mfdr_n.timeMean()+",";
...
//			count ++;
//			System.out.println("PROGRESS:"+ (count*100 / 20 / filenamelist.size()) + "%");
//			RepresentationErrorResult r_mfdr = runOptimalSolutionMFDR(tsset, new BAKMFDRParameterFacade(3,0.5,6.5), NoC ,false);
//			count ++;
//			System.out.println("PROGRESS:"+ (count*100 / 20 / filenamelist.size()) + "%");
...
//			outputstring += "M," + 0+",V," + 0+",T," + 0+",";
//		//  MFDR
//			outputstring += "M," + r_mfdr.errMean()+",V," + r_mfdr.errVariance()+",T," + r_mfdr.timeMean()+",,";
//			fagent.writeLineToFile(outputstring);
//			System.out.println("PROGRESS: " + filenamelist.get(i) + "[" + NoC + "] Stored...");
//			}
//		}
...
//	}
//	
//	public RepresentationErrorResult runOptimalSolutionMFDR(LinkedList<TimeSeries> tsset, BAKMFDRParameterFacade facade, int NoC, boolean usenoise){
